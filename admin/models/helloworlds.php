...
class HelloWorldModelHelloWorlds extends JModelList{
	...
	public function getListQuery(){
		...
		//CRIAR A SOLICITAÇÃO.
		$query->select('a.id AS id, a.texto AS texto, a.published AS published, a.created AS created, a.imagem AS imageInfo, a.latitude AS latitude, a.longitude AS longitude')->from($db->quoteName('#__olamundo', 'a'));
