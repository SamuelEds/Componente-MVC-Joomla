#NOVA MODIFICAÇÃO.
#ATUALIZAÇÃO 0.0.20.
#CRIAR O CAMPO QUE ARMAZENARÁ O ALIAS ('alias').
#ESSE É O CAMPO USADO PARA URL'S AMIGÁVEIS.

ALTER TABLE `#__olamundo` ADD `alias` VARCHAR(40) NOT NULL DEFAULT '' AFTER `texto`;
